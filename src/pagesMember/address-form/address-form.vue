...
// 收集所在地区
const onReachChange: UniHelper.RegionPickerOnChange = (e) => {
  // 更新所在地区
...
const onSubmit = async () => {
  ...
  // 成功提示
  uni.showToast({ icon: 'success', title: query.id ? '编辑成功' : '添加成功' })
  // 返回上一页
  setTimeout(() => {
    uni.navigateBack()
  }, 400)
